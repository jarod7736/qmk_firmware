...
// keymaps
// TODO: Make mod[1]+i home, and mod[1]+a end? like vim?
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_60_ansi_split_space_rshift(
            ...
            KC_LCTL,      KC_LGUI, KC_LALT, LT(2,KC_ENT), MO(1), KC_SPC, KC_RALT, TT(4), MO(3),   KC_RCTL),
	[1] = LAYOUT_60_ansi_split_space_rshift(
            ...
            KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_END,  KC_NO,   KC_NO,  KC_NO,   KC_DEL, KC_TRNS,
            KC_HOME, KC_NO,   KC_NO,   KC_NO,   KC_PGUP, KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END, KC_NO,   KC_TRNS,
	...
	[4] = LAYOUT_60_ansi_split_space_rshift(
            KC_GESC,      KC_1, KC_2, KC_3, 		KC_4,   KC_5,  KC_6, 					KC_7, 		KC_8,    KC_9,   KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
            KC_TAB,       KC_Q, KC_W, KC_E, 		KC_R,   KC_T,  KC_Y, 					KC_U, 		KC_I,    KC_O,   KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
            LT(1,KC_ESC), KC_A, KC_S, KC_D, 		KC_F,   KC_G,  KC_H, 					KC_J, 		KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_ENT,
            KC_LSPO,      KC_Z, KC_X, KC_C, 		KC_V,   KC_B,  KC_N,         	KC_M, 		KC_COMM, KC_DOT, KC_SLSH, KC_RSPC, LT(2,KC_GRV),
            KC_LCTL,      KC_LGUI, 		KC_LALT, 	KC_SPC, MO(1), LT(2,KC_ENT), 	KC_RALT, 	TT(1),		 MO(3),   KC_RCTL),
};
